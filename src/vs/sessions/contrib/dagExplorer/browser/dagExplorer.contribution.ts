...
import { DagExplorerService, IDagExplorerService } from './dagExplorerService.js';
import { DagExplorerView, DAG_EXPLORER_VIEW_ID } from './dagExplorerView.js';
...
const dagExplorerViewIcon = registerIcon('soa-dag-explorer-icon', Codicon.gitCompare, localize('soaDagExplorerIcon', 'View icon for the DAG Explorer.'));
...
Registry.as<IViewsRegistry>(ViewContainerExtensions.ViewsRegistry).registerViews([{
	...
	name: localize2('dagExplorer.view', 'Dependency Graph'),
